...
<article id="itemDetail" class="dishwash">
  ...
  <section class="cart_wrap01">
    ...
    <div class="cart_button">
      <{if $product.model == "refill"}>
      <div class="cart_wrap">
        <span class="txt">定期購入する</span>
        <a class="colorme-repeat-checkout" href="https://colorme-repeat.jp/redirect/6d6f9f03/1624" data-user-slug="6d6f9f03" data-course-id="1624">購入する</a>
      </div>
      <{else}>
      <div class="cart_wrap">
