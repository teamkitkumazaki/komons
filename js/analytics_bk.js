...
var parentWrap = window.top.document; /* iframeから親ドキュメント(チェックアウト画面を指定)*/
parentWrap.postMessage(setCheckoutForm, 'https://komons-japan.com/');

var setCheckoutForm = function() {
